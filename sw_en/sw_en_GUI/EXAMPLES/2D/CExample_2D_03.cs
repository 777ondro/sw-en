    ...
    class CExample_2D_03:CExample
    {
        ...
        */
        public CExample_2D_03()
        {
            ...
            // 1-level
            m_arrNodes[00] = new CNode(01,  500, 000, 0);
            m_arrNodes[01] = new CNode(02, 1000, 000, 0);
            m_arrNodes[02] = new CNode(03, 1500, 000, 0);
            m_arrNodes[03] = new CNode(04, 1750, 000, 0);
            // 2-level
            m_arrNodes[04] = new CNode(05,  350, 300, 0);
            m_arrNodes[05] = new CNode(06,  500, 300, 0);
            m_arrNodes[06] = new CNode(07, 1000, 300, 0);
            m_arrNodes[07] = new CNode(08, 1500, 300, 0);
            m_arrNodes[08] = new CNode(09, 1800, 300, 0);
            // 3-level
            m_arrNodes[09] = new CNode(10,  200, 600, 0);
            m_arrNodes[10] = new CNode(11,  500, 600, 0);
            m_arrNodes[11] = new CNode(12, 1000, 600, 0);
            m_arrNodes[12] = new CNode(13, 1500, 600, 0);
            m_arrNodes[13] = new CNode(14, 1950, 600, 0);
            // 4-level
            m_arrNodes[14] = new CNode(15,  50,  900, 0);
            m_arrNodes[15] = new CNode(16,  500, 900, 0);
            m_arrNodes[16] = new CNode(17, 1000, 900, 0);
            m_arrNodes[17] = new CNode(18, 1500, 900, 0);
            ...
            m_arrNSupports[0] = new CNSupport(m_eNDOF, 1, m_arrNodes[14], bSupport1, 0);
            m_arrNSupports[1] = new CNSupport(m_eNDOF, 2, m_arrNodes[15], bSupport1, 0);
            m_arrNSupports[2] = new CNSupport(m_eNDOF, 3, m_arrNodes[16], bSupport1, 0);
            m_arrNSupports[3] = new CNSupport(m_eNDOF, 4, m_arrNodes[17], bSupport1, 0);
            ...
            m_arrMembers[03].CnRelease1 = new CNRelease(m_eNDOF, m_arrMembers[03].NodeStart, bMembRelase4, 0);
            m_arrMembers[11].CnRelease1 = new CNRelease(m_eNDOF, m_arrMembers[11].NodeStart, bMembRelase4, 0);
            m_arrMembers[19].CnRelease1 = new CNRelease(m_eNDOF, m_arrMembers[19].NodeStart, bMembRelase4, 0);
