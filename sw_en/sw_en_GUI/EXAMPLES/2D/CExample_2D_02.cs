    ...
    class CExample_2D_02 : CExample
    {
        ...
        */
        ...
        public CExample_2D_02()
        {
            ...
            // Upper Chord Nodes
            m_arrNodes[00] = new CNode(01, 0, 0, 0);
            m_arrNodes[01] = new CNode(02, 1, 0, 0);
            m_arrNodes[02] = new CNode(03, 2, 0, 0);
            m_arrNodes[03] = new CNode(04, 3, 0, 0);
            m_arrNodes[04] = new CNode(05, 4, 0, 0);
            m_arrNodes[05] = new CNode(06, 5, 0, 0);
            m_arrNodes[06] = new CNode(07, 6, 0, 0);

            // Bottom Chord Nodes
            m_arrNodes[07] = new CNode(08, 1, 4, 0);
            m_arrNodes[08] = new CNode(09, 2, 6, 0);
            m_arrNodes[09] = new CNode(10, 3, 7, 0);
            m_arrNodes[10] = new CNode(11, 4, 6, 0);
            m_arrNodes[11] = new CNode(12, 5, 4, 0);
