...
namespace sw_en_GUI.EXAMPLES._3D
{
    class CExample_3D_05 : CExample
    {
        ...
        public CExample_3D_05()
        {
            ...
            // Nodes
            m_TopoModel.m_arrNodes[00] = new CNode(01, 000000, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[01] = new CNode(02, 008126, -12769, 05354, 0);
            m_TopoModel.m_arrNodes[02] = new CNode(03, 011471, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[03] = new CNode(04, 014160, -11258, 08980, 0);
            m_TopoModel.m_arrNodes[04] = new CNode(05, 019344, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[05] = new CNode(06, 020317, -9836, 12393, 0);
            m_TopoModel.m_arrNodes[06] = new CNode(07, 026589, -8505, 15589, 0);
            m_TopoModel.m_arrNodes[07] = new CNode(08, 026906, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[08] = new CNode(09, 032969, -7265, 18564, 0);
            m_TopoModel.m_arrNodes[09] = new CNode(10, 034192, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[10] = new CNode(11, 039449, -6119, 21314, 0);
            m_TopoModel.m_arrNodes[11] = new CNode(12, 041234, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[12] = new CNode(13, 046021, -5068, 23837, 0);
            m_TopoModel.m_arrNodes[13] = new CNode(14, 048061, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[14] = new CNode(15, 052677, -4113, 26129, 0);
            m_TopoModel.m_arrNodes[15] = new CNode(16, 054697, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[16] = new CNode(17, 059409, -3255, 28187, 0);
            m_TopoModel.m_arrNodes[17] = new CNode(18, 061167, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[18] = new CNode(19, 066209, -2496, 30009, 0);
            m_TopoModel.m_arrNodes[19] = new CNode(20, 067492, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[20] = new CNode(21, 073068, -1836, 31593, 0);
            m_TopoModel.m_arrNodes[21] = new CNode(22, 073691, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[22] = new CNode(23, 079784, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[23] = new CNode(24, 079979, -1277, 32936, 0);
            m_TopoModel.m_arrNodes[24] = new CNode(25, 085786, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[25] = new CNode(26, 086931, -818, 34037, 0);
            m_TopoModel.m_arrNodes[26] = new CNode(27, 091715, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[27] = new CNode(28, 093919, -460, 34895, 0);
            m_TopoModel.m_arrNodes[28] = new CNode(29, 097586, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[29] = new CNode(30, 100931, -205, 35509, 0);
            m_TopoModel.m_arrNodes[30] = new CNode(31, 103414, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[31] = new CNode(32, 107961, -51, 35877, 0);
            m_TopoModel.m_arrNodes[32] = new CNode(33, 109214, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[33] = new CNode(34, 115000,  0, 36000, 0);
            m_TopoModel.m_arrNodes[34] = new CNode(35, 115000, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[35] = new CNode(36, 120786, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[36] = new CNode(37, 122039, -51, 35877, 0);
            m_TopoModel.m_arrNodes[37] = new CNode(38, 126586, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[38] = new CNode(39, 129069, -205, 35509, 0);
            m_TopoModel.m_arrNodes[39] = new CNode(40, 132414, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[40] = new CNode(41, 136081, -460, 34895, 0);
            m_TopoModel.m_arrNodes[41] = new CNode(42, 138285, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[42] = new CNode(43, 143069, -818, 34037, 0);
            m_TopoModel.m_arrNodes[43] = new CNode(44, 144214, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[44] = new CNode(45, 150021, -1277, 32936, 0);
            m_TopoModel.m_arrNodes[45] = new CNode(46, 150216, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[46] = new CNode(47, 156309, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[47] = new CNode(48, 156932, -1836, 31593, 0);
            m_TopoModel.m_arrNodes[48] = new CNode(49, 162508, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[49] = new CNode(50, 163791, -2496, 30009, 0);
            m_TopoModel.m_arrNodes[50] = new CNode(51, 168833, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[51] = new CNode(52, 170591, -3255, 28187, 0);
            m_TopoModel.m_arrNodes[52] = new CNode(53, 175303, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[53] = new CNode(54, 177323, -4113, 26129, 0);
            m_TopoModel.m_arrNodes[54] = new CNode(55, 181939, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[55] = new CNode(56, 183979, -5068, 23837, 0);
            m_TopoModel.m_arrNodes[56] = new CNode(57, 188766, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[57] = new CNode(58, 190551, -6119, 21314, 0);
            m_TopoModel.m_arrNodes[58] = new CNode(59, 195808, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[59] = new CNode(60, 197031, -7265, 18564, 0);
            m_TopoModel.m_arrNodes[60] = new CNode(61, 203094, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[61] = new CNode(62, 203411, -8505, 15589, 0);
            m_TopoModel.m_arrNodes[62] = new CNode(63, 209683, -9836, 12393, 0);
            m_TopoModel.m_arrNodes[63] = new CNode(64, 210656, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[64] = new CNode(65, 215840, -11258, 08980, 0);
            m_TopoModel.m_arrNodes[65] = new CNode(66, 218529, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[66] = new CNode(67, 221874, -12769, 05354, 0);
            m_TopoModel.m_arrNodes[67] = new CNode(68, 230000, -15000, 00000, 0);
            m_TopoModel.m_arrNodes[068] = new CNode(069, 000000, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[069] = new CNode(070, 008126, 12769, 05354, 0);
            m_TopoModel.m_arrNodes[070] = new CNode(071, 011471, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[071] = new CNode(072, 014160, 11258, 08980, 0);
            m_TopoModel.m_arrNodes[072] = new CNode(073, 019344, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[073] = new CNode(074, 020317, 09836, 12393, 0);
            m_TopoModel.m_arrNodes[074] = new CNode(075, 026589, 08505, 15589, 0);
            m_TopoModel.m_arrNodes[075] = new CNode(076, 026906, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[076] = new CNode(077, 032969, 07265, 18564, 0);
            m_TopoModel.m_arrNodes[077] = new CNode(078, 034192, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[078] = new CNode(079, 039449, 06119, 21314, 0);
            m_TopoModel.m_arrNodes[079] = new CNode(080, 041234, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[080] = new CNode(081, 046021, 05068, 23837, 0);
            m_TopoModel.m_arrNodes[081] = new CNode(082, 048061, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[082] = new CNode(083, 052677, 04113, 26129, 0);
            m_TopoModel.m_arrNodes[083] = new CNode(084, 054697, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[084] = new CNode(085, 059409, 03255, 28187, 0);
            m_TopoModel.m_arrNodes[085] = new CNode(086, 061167, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[086] = new CNode(087, 066209, 02496, 30009, 0);
            m_TopoModel.m_arrNodes[087] = new CNode(088, 067492, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[088] = new CNode(089, 073068, 01836, 31593, 0);
            m_TopoModel.m_arrNodes[089] = new CNode(090, 073691, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[090] = new CNode(091, 079784, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[091] = new CNode(092, 079979, 01277, 32936, 0);
            m_TopoModel.m_arrNodes[092] = new CNode(093, 085786, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[093] = new CNode(094, 086931, 00818, 34037, 0);
            m_TopoModel.m_arrNodes[094] = new CNode(095, 091715, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[095] = new CNode(096, 093919, 00460, 34895, 0);
            m_TopoModel.m_arrNodes[096] = new CNode(097, 097586, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[097] = new CNode(098, 100931, 00205, 35509, 0);
            m_TopoModel.m_arrNodes[098] = new CNode(099, 103414, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[099] = new CNode(100, 107961, 00051, 35877, 0);
            m_TopoModel.m_arrNodes[100] = new CNode(101, 109214, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[101] = new CNode(102, 115000, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[102] = new CNode(103, 120786, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[103] = new CNode(104, 122039, 00051, 35877, 0);
            m_TopoModel.m_arrNodes[104] = new CNode(105, 126586, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[105] = new CNode(106, 129069, 00205, 35509, 0);
            m_TopoModel.m_arrNodes[106] = new CNode(107, 132414, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[107] = new CNode(108, 136081, 00460, 34895, 0);
            m_TopoModel.m_arrNodes[108] = new CNode(109, 138285, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[109] = new CNode(110, 143069, 00818, 34037, 0);
            m_TopoModel.m_arrNodes[110] = new CNode(111, 144214, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[111] = new CNode(112, 150021, 01277, 32936, 0);
            m_TopoModel.m_arrNodes[112] = new CNode(113, 150216, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[113] = new CNode(114, 156309, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[114] = new CNode(115, 156932, 01836, 31593, 0);
            m_TopoModel.m_arrNodes[115] = new CNode(116, 162508, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[116] = new CNode(117, 163791, 02496, 30009, 0);
            m_TopoModel.m_arrNodes[117] = new CNode(118, 168833, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[118] = new CNode(119, 170591, 03255, 28187, 0);
            m_TopoModel.m_arrNodes[119] = new CNode(120, 175303, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[120] = new CNode(121, 177323, 04113, 26129, 0);
            m_TopoModel.m_arrNodes[121] = new CNode(122, 181939, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[122] = new CNode(123, 183979, 05068, 23837, 0);
            m_TopoModel.m_arrNodes[123] = new CNode(124, 188766, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[124] = new CNode(125, 190551, 06119, 21314, 0);
            m_TopoModel.m_arrNodes[125] = new CNode(126, 195808, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[126] = new CNode(127, 197031, 07265, 18564, 0);
            m_TopoModel.m_arrNodes[127] = new CNode(128, 203094, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[128] = new CNode(129, 203411, 08505, 15589, 0);
            m_TopoModel.m_arrNodes[129] = new CNode(130, 209683, 09836, 12393, 0);
            m_TopoModel.m_arrNodes[130] = new CNode(131, 210656, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[131] = new CNode(132, 215840, 11258, 08980, 0);
            m_TopoModel.m_arrNodes[132] = new CNode(133, 218529, 15000, 00000, 0);
            m_TopoModel.m_arrNodes[133] = new CNode(134, 221874, 12769, 05354, 0);
            m_TopoModel.m_arrNodes[134] = new CNode(135, 230000, 15000, 00000, 0);
            ...
            m_TopoModel.m_arrMembers[101] = new CMember(102, m_TopoModel.m_arrNodes[068], m_TopoModel.m_arrNodes[069], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[102] = new CMember(103, m_TopoModel.m_arrNodes[068], m_TopoModel.m_arrNodes[070], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[103] = new CMember(104, m_TopoModel.m_arrNodes[070], m_TopoModel.m_arrNodes[069], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[104] = new CMember(105, m_TopoModel.m_arrNodes[069], m_TopoModel.m_arrNodes[071], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[105] = new CMember(106, m_TopoModel.m_arrNodes[070], m_TopoModel.m_arrNodes[072], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[106] = new CMember(107, m_TopoModel.m_arrNodes[072], m_TopoModel.m_arrNodes[071], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[107] = new CMember(108, m_TopoModel.m_arrNodes[071], m_TopoModel.m_arrNodes[073], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[108] = new CMember(109, m_TopoModel.m_arrNodes[072], m_TopoModel.m_arrNodes[075], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[109] = new CMember(110, m_TopoModel.m_arrNodes[073], m_TopoModel.m_arrNodes[074], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[110] = new CMember(111, m_TopoModel.m_arrNodes[075], m_TopoModel.m_arrNodes[073], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[111] = new CMember(112, m_TopoModel.m_arrNodes[074], m_TopoModel.m_arrNodes[076], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[112] = new CMember(113, m_TopoModel.m_arrNodes[074], m_TopoModel.m_arrNodes[077], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[113] = new CMember(114, m_TopoModel.m_arrNodes[075], m_TopoModel.m_arrNodes[077], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[114] = new CMember(115, m_TopoModel.m_arrNodes[076], m_TopoModel.m_arrNodes[078], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[115] = new CMember(116, m_TopoModel.m_arrNodes[076], m_TopoModel.m_arrNodes[079], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[116] = new CMember(117, m_TopoModel.m_arrNodes[077], m_TopoModel.m_arrNodes[079], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[117] = new CMember(118, m_TopoModel.m_arrNodes[078], m_TopoModel.m_arrNodes[080], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[118] = new CMember(119, m_TopoModel.m_arrNodes[078], m_TopoModel.m_arrNodes[081], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[119] = new CMember(120, m_TopoModel.m_arrNodes[079], m_TopoModel.m_arrNodes[081], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[120] = new CMember(121, m_TopoModel.m_arrNodes[080], m_TopoModel.m_arrNodes[082], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[121] = new CMember(122, m_TopoModel.m_arrNodes[080], m_TopoModel.m_arrNodes[083], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[122] = new CMember(123, m_TopoModel.m_arrNodes[081], m_TopoModel.m_arrNodes[083], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[123] = new CMember(124, m_TopoModel.m_arrNodes[082], m_TopoModel.m_arrNodes[084], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[124] = new CMember(125, m_TopoModel.m_arrNodes[082], m_TopoModel.m_arrNodes[085], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[125] = new CMember(126, m_TopoModel.m_arrNodes[083], m_TopoModel.m_arrNodes[085], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[126] = new CMember(127, m_TopoModel.m_arrNodes[084], m_TopoModel.m_arrNodes[086], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[127] = new CMember(128, m_TopoModel.m_arrNodes[084], m_TopoModel.m_arrNodes[087], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[128] = new CMember(129, m_TopoModel.m_arrNodes[085], m_TopoModel.m_arrNodes[087], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[129] = new CMember(130, m_TopoModel.m_arrNodes[086], m_TopoModel.m_arrNodes[088], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[130] = new CMember(131, m_TopoModel.m_arrNodes[086], m_TopoModel.m_arrNodes[089], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[131] = new CMember(132, m_TopoModel.m_arrNodes[087], m_TopoModel.m_arrNodes[089], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[132] = new CMember(133, m_TopoModel.m_arrNodes[088], m_TopoModel.m_arrNodes[090], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[133] = new CMember(134, m_TopoModel.m_arrNodes[088], m_TopoModel.m_arrNodes[091], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[134] = new CMember(135, m_TopoModel.m_arrNodes[089], m_TopoModel.m_arrNodes[090], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[135] = new CMember(136, m_TopoModel.m_arrNodes[090], m_TopoModel.m_arrNodes[092], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[136] = new CMember(137, m_TopoModel.m_arrNodes[091], m_TopoModel.m_arrNodes[092], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[137] = new CMember(138, m_TopoModel.m_arrNodes[091], m_TopoModel.m_arrNodes[093], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[138] = new CMember(139, m_TopoModel.m_arrNodes[092], m_TopoModel.m_arrNodes[094], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[139] = new CMember(140, m_TopoModel.m_arrNodes[093], m_TopoModel.m_arrNodes[094], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[140] = new CMember(141, m_TopoModel.m_arrNodes[093], m_TopoModel.m_arrNodes[095], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[141] = new CMember(142, m_TopoModel.m_arrNodes[094], m_TopoModel.m_arrNodes[096], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[142] = new CMember(143, m_TopoModel.m_arrNodes[095], m_TopoModel.m_arrNodes[096], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[143] = new CMember(144, m_TopoModel.m_arrNodes[095], m_TopoModel.m_arrNodes[097], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[144] = new CMember(145, m_TopoModel.m_arrNodes[096], m_TopoModel.m_arrNodes[098], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[145] = new CMember(146, m_TopoModel.m_arrNodes[097], m_TopoModel.m_arrNodes[098], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[146] = new CMember(147, m_TopoModel.m_arrNodes[097], m_TopoModel.m_arrNodes[099], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[147] = new CMember(148, m_TopoModel.m_arrNodes[098], m_TopoModel.m_arrNodes[100], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[148] = new CMember(149, m_TopoModel.m_arrNodes[099], m_TopoModel.m_arrNodes[100], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[149] = new CMember(150, m_TopoModel.m_arrNodes[099], m_TopoModel.m_arrNodes[033], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[150] = new CMember(151, m_TopoModel.m_arrNodes[100], m_TopoModel.m_arrNodes[101], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[151] = new CMember(152, m_TopoModel.m_arrNodes[033], m_TopoModel.m_arrNodes[101], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[152] = new CMember(153, m_TopoModel.m_arrNodes[033], m_TopoModel.m_arrNodes[103], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[153] = new CMember(154, m_TopoModel.m_arrNodes[101], m_TopoModel.m_arrNodes[102], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[154] = new CMember(155, m_TopoModel.m_arrNodes[102], m_TopoModel.m_arrNodes[103], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[155] = new CMember(156, m_TopoModel.m_arrNodes[102], m_TopoModel.m_arrNodes[104], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[156] = new CMember(157, m_TopoModel.m_arrNodes[103], m_TopoModel.m_arrNodes[105], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[157] = new CMember(158, m_TopoModel.m_arrNodes[104], m_TopoModel.m_arrNodes[105], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[158] = new CMember(159, m_TopoModel.m_arrNodes[104], m_TopoModel.m_arrNodes[106], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[159] = new CMember(160, m_TopoModel.m_arrNodes[105], m_TopoModel.m_arrNodes[107], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[160] = new CMember(161, m_TopoModel.m_arrNodes[106], m_TopoModel.m_arrNodes[107], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[161] = new CMember(162, m_TopoModel.m_arrNodes[106], m_TopoModel.m_arrNodes[108], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[162] = new CMember(163, m_TopoModel.m_arrNodes[107], m_TopoModel.m_arrNodes[109], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[163] = new CMember(164, m_TopoModel.m_arrNodes[108], m_TopoModel.m_arrNodes[109], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[164] = new CMember(165, m_TopoModel.m_arrNodes[108], m_TopoModel.m_arrNodes[110], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[165] = new CMember(166, m_TopoModel.m_arrNodes[109], m_TopoModel.m_arrNodes[111], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[166] = new CMember(167, m_TopoModel.m_arrNodes[110], m_TopoModel.m_arrNodes[111], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[167] = new CMember(168, m_TopoModel.m_arrNodes[110], m_TopoModel.m_arrNodes[112], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[168] = new CMember(169, m_TopoModel.m_arrNodes[111], m_TopoModel.m_arrNodes[114], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[169] = new CMember(170, m_TopoModel.m_arrNodes[112], m_TopoModel.m_arrNodes[114], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[170] = new CMember(171, m_TopoModel.m_arrNodes[112], m_TopoModel.m_arrNodes[113], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[171] = new CMember(172, m_TopoModel.m_arrNodes[114], m_TopoModel.m_arrNodes[116], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[172] = new CMember(173, m_TopoModel.m_arrNodes[113], m_TopoModel.m_arrNodes[116], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[173] = new CMember(174, m_TopoModel.m_arrNodes[113], m_TopoModel.m_arrNodes[115], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[174] = new CMember(175, m_TopoModel.m_arrNodes[116], m_TopoModel.m_arrNodes[118], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[175] = new CMember(176, m_TopoModel.m_arrNodes[115], m_TopoModel.m_arrNodes[118], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[176] = new CMember(177, m_TopoModel.m_arrNodes[115], m_TopoModel.m_arrNodes[117], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[177] = new CMember(178, m_TopoModel.m_arrNodes[118], m_TopoModel.m_arrNodes[120], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[178] = new CMember(179, m_TopoModel.m_arrNodes[117], m_TopoModel.m_arrNodes[120], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[179] = new CMember(180, m_TopoModel.m_arrNodes[117], m_TopoModel.m_arrNodes[119], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[180] = new CMember(181, m_TopoModel.m_arrNodes[120], m_TopoModel.m_arrNodes[122], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[181] = new CMember(182, m_TopoModel.m_arrNodes[119], m_TopoModel.m_arrNodes[122], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[182] = new CMember(183, m_TopoModel.m_arrNodes[119], m_TopoModel.m_arrNodes[121], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[183] = new CMember(184, m_TopoModel.m_arrNodes[122], m_TopoModel.m_arrNodes[124], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[184] = new CMember(185, m_TopoModel.m_arrNodes[121], m_TopoModel.m_arrNodes[124], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[185] = new CMember(186, m_TopoModel.m_arrNodes[121], m_TopoModel.m_arrNodes[123], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[186] = new CMember(187, m_TopoModel.m_arrNodes[124], m_TopoModel.m_arrNodes[126], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[187] = new CMember(188, m_TopoModel.m_arrNodes[123], m_TopoModel.m_arrNodes[126], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[188] = new CMember(189, m_TopoModel.m_arrNodes[123], m_TopoModel.m_arrNodes[125], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[189] = new CMember(190, m_TopoModel.m_arrNodes[126], m_TopoModel.m_arrNodes[128], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[190] = new CMember(191, m_TopoModel.m_arrNodes[125], m_TopoModel.m_arrNodes[128], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[191] = new CMember(192, m_TopoModel.m_arrNodes[125], m_TopoModel.m_arrNodes[127], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[192] = new CMember(193, m_TopoModel.m_arrNodes[128], m_TopoModel.m_arrNodes[129], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[193] = new CMember(194, m_TopoModel.m_arrNodes[127], m_TopoModel.m_arrNodes[129], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[194] = new CMember(195, m_TopoModel.m_arrNodes[127], m_TopoModel.m_arrNodes[130], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[195] = new CMember(196, m_TopoModel.m_arrNodes[129], m_TopoModel.m_arrNodes[131], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[196] = new CMember(197, m_TopoModel.m_arrNodes[130], m_TopoModel.m_arrNodes[131], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[197] = new CMember(198, m_TopoModel.m_arrNodes[130], m_TopoModel.m_arrNodes[132], m_TopoModel.m_arrCrSc[0], 0);
            m_TopoModel.m_arrMembers[198] = new CMember(199, m_TopoModel.m_arrNodes[131], m_TopoModel.m_arrNodes[133], m_TopoModel.m_arrCrSc[0], 0);
