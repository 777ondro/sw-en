    ...
    class CExample_3D_80 : CExample
    {
        public CExample_3D_80()
        {
            ...
            */
            ...
            m_arrGOVolumes[162] = new CVolume(163, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[162], 1, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[163] = new CVolume(164, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[163], 1, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[164] = new CVolume(165, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[164], 1, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[165] = new CVolume(166, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[165], 1, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[166] = new CVolume(167, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[166], 1, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[167] = new CVolume(168, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[167], 0.5f, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[168] = new CVolume(169, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[168], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[169] = new CVolume(170, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[169], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[170] = new CVolume(171, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[170], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[171] = new CVolume(172, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[171], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[172] = new CVolume(173, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[172], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[173] = new CVolume(174, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[173], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[174] = new CVolume(175, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[174], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[175] = new CVolume(176, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[175], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[176] = new CVolume(177, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[176], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[177] = new CVolume(178, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[177], 0.5f, 1, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[178] = new CVolume(179, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[178], 0.5f, 0.5f, 0.5f,  DiffMat2_Plaster, DiffMat2_Plaster, true, 0);

            // Level 4 [+3.000]
            vColor = Color.FromRgb(229, 255, 204);

            m_arrGOVolumes[179] = new CVolume(180, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[179], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[180] = new CVolume(181, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[180], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[181] = new CVolume(182, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[181], 1, 0.5f, 0.5f, DiffMat2_Plaster, false, 0);
            m_arrGOVolumes[182] = new CVolume(183, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[182], 1, 0.5f, 0.5f, DiffMat2_Plaster, false, 0);
            m_arrGOVolumes[183] = new CVolume(184, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[183], 1, 0.5f, 0.5f, DiffMat2_Plaster, false, 0);
            m_arrGOVolumes[184] = new CVolume(185, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[184], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[185] = new CVolume(186, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[185], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[186] = new CVolume(187, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[186], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[187] = new CVolume(188, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[187], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[188] = new CVolume(189, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[188], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[189] = new CVolume(190, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[189], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[190] = new CVolume(191, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[190], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[191] = new CVolume(192, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[191], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[192] = new CVolume(193, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[192], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[193] = new CVolume(194, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[193], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[194] = new CVolume(195, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[194], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[195] = new CVolume(196, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[195], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[196] = new CVolume(197, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[196], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[197] = new CVolume(198, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[197], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[198] = new CVolume(199, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[198], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[199] = new CVolume(200, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[199], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[200] = new CVolume(201, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[200], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[201] = new CVolume(202, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[201], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[202] = new CVolume(203, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[202], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[203] = new CVolume(204, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[203], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[204] = new CVolume(205, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[204], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[205] = new CVolume(206, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[205], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[206] = new CVolume(207, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[206], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[207] = new CVolume(208, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[207], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[208] = new CVolume(209, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[208], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[209] = new CVolume(210, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[209], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[210] = new CVolume(211, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[210], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[211] = new CVolume(212, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[211], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[212] = new CVolume(213, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[212], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[213] = new CVolume(214, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[213], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[214] = new CVolume(215, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[214], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[215] = new CVolume(216, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[215], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[216] = new CVolume(217, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[216], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[217] = new CVolume(218, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[217], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[218] = new CVolume(219, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[218], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[219] = new CVolume(220, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[219], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[220] = new CVolume(221, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[220], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[221] = new CVolume(222, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[221], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[222] = new CVolume(223, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[222], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[223] = new CVolume(224, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[223], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[224] = new CVolume(225, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[224], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[225] = new CVolume(226, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[225], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[226] = new CVolume(227, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[226], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[275] = new CVolume(276, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[275], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[276] = new CVolume(277, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[276], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[280] = new CVolume(281, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[280], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[281] = new CVolume(282, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[281], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[282] = new CVolume(283, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[282], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[285] = new CVolume(286, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[285], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[286] = new CVolume(287, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[286], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[287] = new CVolume(288, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[287], 0.5f, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[288] = new CVolume(289, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[288], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[289] = new CVolume(290, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[289], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[292] = new CVolume(293, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[292], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[293] = new CVolume(294, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[293], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[296] = new CVolume(297, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[296], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[297] = new CVolume(298, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[297], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[298] = new CVolume(299, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[298], 0.5f, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[299] = new CVolume(300, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[299], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[300] = new CVolume(301, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[300], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[303] = new CVolume(304, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[303], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[304] = new CVolume(305, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[304], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[305] = new CVolume(306, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[305], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[306] = new CVolume(307, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[306], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[309] = new CVolume(310, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[309], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[310] = new CVolume(311, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[310], 1, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[311] = new CVolume(312, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[311], 0.5f, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[312] = new CVolume(313, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[312], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[313] = new CVolume(314, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[313], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[316] = new CVolume(317, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[316], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[317] = new CVolume(318, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[317], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            ...
            m_arrGOVolumes[320] = new CVolume(321, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[320], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[321] = new CVolume(322, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[321], 0.5f, 1, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[322] = new CVolume(323, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[322], 0.5f, 0.5f, 1.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);

            // Level 7 [+5.500]

            m_arrGOVolumes[323] = new CVolume(324, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[323], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[324] = new CVolume(325, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[324], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[325] = new CVolume(326, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[325], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[326] = new CVolume(327, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[326], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[327] = new CVolume(328, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[327], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[328] = new CVolume(329, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[328], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[329] = new CVolume(330, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[329], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[330] = new CVolume(331, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[330], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[331] = new CVolume(332, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[331], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[332] = new CVolume(333, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[332], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[333] = new CVolume(334, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[333], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[334] = new CVolume(335, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[334], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[335] = new CVolume(336, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[335], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[336] = new CVolume(337, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[336], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[337] = new CVolume(338, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[337], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[338] = new CVolume(339, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[338], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[339] = new CVolume(340, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[339], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[340] = new CVolume(341, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[340], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[341] = new CVolume(342, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[341], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[342] = new CVolume(343, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[342], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[343] = new CVolume(344, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[343], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[344] = new CVolume(345, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[344], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[345] = new CVolume(346, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[345], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[346] = new CVolume(347, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[346], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[347] = new CVolume(348, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[347], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[348] = new CVolume(349, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[348], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[349] = new CVolume(350, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[349], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[350] = new CVolume(351, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[350], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[351] = new CVolume(352, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[351], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[352] = new CVolume(353, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[352], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[353] = new CVolume(354, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[353], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[354] = new CVolume(355, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[354], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[355] = new CVolume(356, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[355], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[356] = new CVolume(357, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[356], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[357] = new CVolume(358, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[357], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[358] = new CVolume(359, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[358], 1, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[359] = new CVolume(360, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[359], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[360] = new CVolume(361, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[360], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[361] = new CVolume(362, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[361], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[362] = new CVolume(363, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[362], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[363] = new CVolume(364, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[363], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[364] = new CVolume(365, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[364], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[365] = new CVolume(366, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[365], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[366] = new CVolume(367, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[366], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[367] = new CVolume(368, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[367], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[368] = new CVolume(369, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[368], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[369] = new CVolume(370, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[369], 0.5f, 1, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
            m_arrGOVolumes[370] = new CVolume(371, EVolumeShapeType.eShape3DPrism_8Edges, m_arrGOPoints[370], 0.5f, 0.5f, 0.5f, DiffMat2_WindowLedge, DiffMat2_Plaster, true, 0);
