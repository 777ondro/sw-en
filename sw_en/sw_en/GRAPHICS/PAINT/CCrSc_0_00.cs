...
namespace CENEX
{
    ...
    public class CCrSc_0_00:CCrSc
    {
        ...
        //----------------------------------------------------------------------------
        public CCrSc_0_00()  {   }
        public CCrSc_0_00(float fd, int iTotNoPoints)
        {
        ...
        void CalcCrSc_Coord()
        {
            ...
            {
                m_CrScPoint[i, 0] = GetPositionX(m_fr_out, i * 180 / (ITotNoPoints-1));  // y
                m_CrScPoint[i, 1] = GetPositionY(m_fr_out, i * 180 / (ITotNoPoints-1));  // z
            }
