...
namespace CENEX
{
    class CTest4
    {
        ...
        public CTest4()
        {
            ...
            arrLines[03] = new CLine(04, arrNodes[03], arrNodes[04], 0);
            arrLines[04] = new CLine(05, arrNodes[04], arrNodes[05], 0);
            arrLines[05] = new CLine(06, arrNodes[05], arrNodes[06], 0);
            arrLines[06] = new CLine(07, arrNodes[06], arrNodes[07], 0);
            ...
            // 2-upper chord
            arrLines[10] = new CLine(11, arrNodes[11], arrNodes[12], 0);
            arrLines[11] = new CLine(12, arrNodes[12], arrNodes[13], 0);
            arrLines[12] = new CLine(13, arrNodes[13], arrNodes[14], 0);
            arrLines[13] = new CLine(14, arrNodes[14], arrNodes[15], 0);
            arrLines[14] = new CLine(15, arrNodes[15], arrNodes[16], 0);
            arrLines[15] = new CLine(16, arrNodes[16], arrNodes[17], 0);
            arrLines[16] = new CLine(17, arrNodes[17], arrNodes[18], 0);
            arrLines[17] = new CLine(18, arrNodes[18], arrNodes[19], 0);
            arrLines[18] = new CLine(19, arrNodes[19], arrNodes[20], 0);
            arrLines[19] = new CLine(20, arrNodes[20], arrNodes[21], 0);
            // 3-stops / columns / verticals
            arrLines[20] = new CLine(21, arrNodes[00], arrNodes[11], 0);
            arrLines[21] = new CLine(22, arrNodes[01], arrNodes[12], 0);
            arrLines[22] = new CLine(23, arrNodes[02], arrNodes[13], 0);
            arrLines[23] = new CLine(24, arrNodes[03], arrNodes[14], 0);
            arrLines[24] = new CLine(25, arrNodes[04], arrNodes[15], 0);
            arrLines[25] = new CLine(26, arrNodes[05], arrNodes[16], 0);
            arrLines[26] = new CLine(27, arrNodes[06], arrNodes[17], 0);
            arrLines[27] = new CLine(28, arrNodes[07], arrNodes[18], 0);
            arrLines[28] = new CLine(29, arrNodes[08], arrNodes[19], 0);
            arrLines[29] = new CLine(30, arrNodes[09], arrNodes[20], 0);
            arrLines[30] = new CLine(31, arrNodes[10], arrNodes[21], 0);
            // 4-diagonals
            arrLines[31] = new CLine(32, arrNodes[01], arrNodes[11], 0);
            arrLines[32] = new CLine(33, arrNodes[02], arrNodes[12], 0);
            arrLines[33] = new CLine(34, arrNodes[03], arrNodes[13], 0);
            arrLines[34] = new CLine(35, arrNodes[04], arrNodes[14], 0);
            arrLines[35] = new CLine(36, arrNodes[05], arrNodes[15], 0);
            arrLines[36] = new CLine(37, arrNodes[05], arrNodes[17], 0);
            arrLines[37] = new CLine(38, arrNodes[06], arrNodes[18], 0);
            arrLines[38] = new CLine(39, arrNodes[07], arrNodes[19], 0);
            arrLines[39] = new CLine(40, arrNodes[08], arrNodes[20], 0);
            arrLines[40] = new CLine(41, arrNodes[09], arrNodes[21], 0);
            ...
            arrSupports[1] = new CNSupport(2, arrNodes[10], bSupport2, 0);
            ...
            arrLines[32].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[33].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[34].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[35].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[36].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[37].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[38].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[39].m_iMR = new CMembRelease(0, bMembRelase1, 0);
            arrLines[40].m_iMR = new CMembRelease(0, bMembRelase1, 0);
