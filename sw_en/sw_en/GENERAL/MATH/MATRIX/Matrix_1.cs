...
namespace FEM_CALC_1D1
{


    /*
    Matrix class in C#
    Written by Ivan Kuckir (ivan.kuckir@gmail.com, www.ivank.net/en)
    Faculty of Mathematics and Physics
    Charles University in Prague
    (C) 2010
     * 
     * 
     * Obsahuje mocnění celým číslem (-1 : inverze, ...), LU rozklad, který se dál používá pro výpočet determinantu inverze a řešení systému lineárních rovnic.
     * Samozřejmostí jsou standardní funkce jako sčítání matic, násobení, transpozice ... Třída má vlastní systém vyjímek a přetížené operátory
*/
    ...
    public class Matrix
{
    ...
    public Matrix SolveWith(Matrix v)                        // Function solves Ax = v in confirmity with solution vector "v"
    {
        ...
        for (int i = 0; i < rows; i++) b[pi[i], 0] = v[i, 0];   // switch two items in "v" due to permutation matrix
    ...
    public static Matrix Parse(string s)                        // Function parses the matrix from string
    {
    ...
    public static Matrix Transpose(Matrix m)              // Matrix transpose
    {
