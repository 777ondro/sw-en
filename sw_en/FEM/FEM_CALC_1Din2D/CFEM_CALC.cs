...
namespace FEM_CALC_1Din2D
{
    public class CFEM_CALC
    {
        ...
        public CFEM_CALC()
        {
            ...
            Console.WriteLine("Member load vector - primary end forces in LCS at start node ID: " + FEMModel.m_arrFemMembers[i].m_NodeStart.INode_ID + " - Dimensions: 3 x 1 \n");
            FEMModel.m_arrFemMembers[i].m_VElemPEF_LCS_StNode.Print1DVector();
            Console.WriteLine("Member load vector - primary end forces in LCS at end node ID: " + FEMModel.m_arrFemMembers[i].m_NodeEnd.INode_ID + " - Dimensions: 3 x 1 \n");
