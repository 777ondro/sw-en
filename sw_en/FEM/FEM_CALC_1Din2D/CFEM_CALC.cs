...
namespace FEM_CALC_1Din2D
{
    public class CFEM_CALC
    {
        ...
        public CFEM_CALC()
        {
            ...
            Console.WriteLine("Local stiffeness matrix k" + FEMModel.m_arrFemMembers[i].NodeStart.INode_ID + FEMModel.m_arrFemMembers[i].NodeEnd.INode_ID + "0 - Dimensions: 3 x 3 \n");
            ...
            Console.WriteLine("Global stiffeness matrix K" + FEMModel.m_arrFemMembers[i].NodeStart.INode_ID + FEMModel.m_arrFemMembers[i].NodeEnd.INode_ID + "0 - Dimensions: 6 x 6 \n");
            ...
            Console.WriteLine("Member load vector - primary end forces in LCS at start node ID: " + FEMModel.m_arrFemMembers[i].NodeStart.INode_ID + " - Dimensions: 3 x 1 \n");
            FEMModel.m_arrFemMembers[i].m_VElemPEF_LCS_StNode.Print1DVector();
            Console.WriteLine("Member load vector - primary end forces in LCS at end node ID: " + FEMModel.m_arrFemMembers[i].NodeEnd.INode_ID + " - Dimensions: 3 x 1 \n");
